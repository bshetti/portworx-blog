...
2.  **Portworx** XXXXXXXX Portworx was configured with redundant volumes supporting the K8S cluster. These volumes, configured at 200G, support the Postgres deployment. In addition portworx "free" version was used. This allows us to ensure we get the most basic configuration comparison.
